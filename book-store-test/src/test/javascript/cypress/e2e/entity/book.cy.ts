...
describe('Book e2e test', () => {
  ...
  const bookSample = { title: 'seep well' };
  ...
  describe('new Book page', () => {
    ...
    it('should create an instance of Book', () => {
      cy.get(`[data-cy="title"]`).type('faithfully buoyant');
      cy.get(`[data-cy="title"]`).should('have.value', 'faithfully buoyant');

      cy.get(`[data-cy="publicationDate"]`).type('2024-01-22T23:22');
      cy.get(`[data-cy="publicationDate"]`).blur();
      cy.get(`[data-cy="publicationDate"]`).should('have.value', '2024-01-22T23:22');
